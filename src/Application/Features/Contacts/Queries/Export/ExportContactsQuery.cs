         ...
         IRequestHandler<ExportContactsQuery, Result<byte[]>>
{
        ...
        #nullable disable warnings
        public async ValueTask<Result<byte[]>> Handle(ExportContactsQuery request, CancellationToken cancellationToken)
        {
            ...
            var result = await _excelService.ExportAsync(data,
                new Dictionary<string, Func<ContactDto, object?>>()
                {
                 ...
                 {_localizer[_dto.GetMemberDisplayName(x=>x.Country)],item => item.Country}, 
